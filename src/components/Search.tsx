  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <input
          type="text"
          className="w-full py-2 pl-10 pr-10 text-sm bg-gray-100 border border-gray-300 rounded-lg dark:bg-glaucous dark:border-silver-lake-blue dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
