...
const ProductDetailSkeleton: React.FC = () => {
  return (
    ...
    >
      <div className="sticky top-0 z-20 flex items-center justify-between w-full gap-2 p-4 bg-white/95 dark:bg-grayshade-400/95 backdrop-blur-sm md:absolute md:w-auto md:right-6 md:top-8 md:bg-transparent md:p-0 md:dark:bg-transparent">
